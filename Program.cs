...
namespace DateTimeandMath
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(DateTime.Now.ToString("ddd")); //salı
            ...
            //Math Kütüphanesi
            Console.WriteLine(Math.Abs(-53)); //53
            Console.WriteLine(Math.Sin(10)); //53
            Console.WriteLine(Math.Cos(10)); //53
            Console.WriteLine(Math.Tan(10)); //53
            ...
            Console.WriteLine(Math.Pow(3,4)); //3^4 ü verir. B1.
            ...
            Console.WriteLine(Math.Log10(10)); // 10 sayısının logaritma10 tabnındaki karşılığı
        }
    }
}